...
INSERT INTO pac_info(CODE,NAME,AGE,ADDRESS,CALLNUM) VALUES(1,'이영란',24,'331-755','010-4558-2446');
INSERT INTO pac_info(CODE,NAME,AGE,ADDRESS,CALLNUM) VALUES(2,'유지나',38,'234-754','010-8787-5882');
INSERT INTO pac_info(CODE,NAME,AGE,ADDRESS,CALLNUM) VALUES(3,'강수양',16,'584-476','010-7995-6282');
INSERT INTO pac_info(CODE,NAME,AGE,ADDRESS,CALLNUM) VALUES(4,'강지웅',40,'664-721','010-1245-6974');
INSERT INTO pac_info(CODE,NAME,AGE,ADDRESS,CALLNUM) VALUES(5,'류태현',29,'257-882','010-4567-8878');

DROP TABLE IF EXISTS med_record;
CREATE TABLE med_record (
	DOCID		varchar(20)	FOREIGN KEY REFERENCES doc_info(ID),
	PACCODE		varchar(25)	FOREIGN KEY REFERENCES pac_info(CODE),
	MEDDATE		DATE		not null,
	OXYGEN		varchar(20)	not null,
	TEMPERATURE	varchar(20)	not null,
	PRIMARY KEY(DOCID, PACCODE)
);
